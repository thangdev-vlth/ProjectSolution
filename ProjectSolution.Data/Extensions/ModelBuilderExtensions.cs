...
using ProjectSolution.Data.Enums;
...
namespace ProjectSolution.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
               new AppConfig() { Key = "HomeTitle", Value = "This is home page of ProjectSolution" },
               new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of ProjectSolution" },
               new AppConfig() { Key = "HomeDescription", Value = "This is description of ProjectSolution" }
               );
